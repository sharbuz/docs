...
![User List](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-6-49.png)

### 2. Open Role Mappings

In the `User details` page, navigate to the `Role mappings` tab.

![Role Mappings Tab](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-7-38.png)
...
![Select Role](@site/docs/admin/configuration/images/user-configuration/image-2025-9-15_1-8-8.png)
