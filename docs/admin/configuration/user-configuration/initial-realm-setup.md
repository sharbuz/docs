...
![Realm Selected](@site/docs/admin/configuration/images/user-configuration/image-2025-9-16_16-23-9.png)

### 3. Navigate to Realm Settings

Click on **Realm Settings** in the left sidebar menu.

![Realm Settings](@site/docs/admin/configuration/images/user-configuration/image-2025-9-16_16-23-49.png)
...
![Enable Unmanaged Attributes](@site/docs/admin/configuration/images/user-configuration/image-2025-9-16_16-34-28.png)

![Select Enabled](@site/docs/admin/configuration/images/user-configuration/image-2025-9-16_16-34-52.png)

![Save Changes](@site/docs/admin/configuration/images/user-configuration/image-2025-9-16_16-36-10.png)
