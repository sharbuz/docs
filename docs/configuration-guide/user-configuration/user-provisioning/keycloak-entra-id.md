...
description: Integrate with Microsoft Entra ID for SSO
---
...
![Microsoft Entra ID](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-13-10.png)

![App Registrations](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-13-54.png)
...
![New Registration](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-24-34.png)

![Registration Form](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-15-57.png)

### 3. Create Client Secret

From the app's side menu, navigate to `Certificates & secrets` and click `New client secret`.

![Certificates & Secrets](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-27-16.png)

![New Client Secret](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-29-40.png)

### 4. Save the Client Secret Value

Give the secret a **Description** (e.g., `Keycloak Secret`) and click `Add`.

![Secret Description](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-33-15.png)

![Copy Secret](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-34-3.png)
...
![API Permissions](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-35-52.png)

![Permissions List](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-36-44.png)
...
![Identity Providers](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-40-46.png)

![OpenID Connect](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-41-19.png)
...
![Application ID](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-53-20.png)

![Endpoints](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-59-40.png)

![Metadata URL](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_3-53-47.png)
...
![Provider Configuration](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-13-10.png)
...
![Copy Redirect URI](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-19-2.png)
...
![Authentication Tab](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-20-13.png)

![Add Platform](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-21-19.png)

![Select Web](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-21-40.png)

**Paste the URI and Save:** In the "Redirect URIs" field, paste the URI you copied from Keycloak and click **Configure**.

![Configure Redirect URI](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-24-53.png)
...
![Mappers Tab](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_5-35-59.png)

Click **Add mapper** to open the configuration form.

![Add Mapper](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_5-36-28.png)
...
![Role Mapper Configuration](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-34-2.png)
...
![Attribute Mapper Configuration](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-43-39.png)
...
![SSO Login](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_4-58-57.png)
...
![Admin Consent](@site/docs/configuration-guide/images/user-configuration/image-2025-9-19_5-0-18.png)
