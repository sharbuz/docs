...
### How do I backup AI/Run CodeMie data?

Data is stored in Elasticsearch and PostgreSQL. Use standard backup procedures for these databases.

### Can I use external Elasticsearch?

Yes, configure the external Elasticsearch endpoint in the AI/Run CodeMie API values file.

### How do I scale AI/Run CodeMie?

Adjust the replica count in the Helm values files for codemie-api and codemie-ui components.

### What are the network requirements?

Refer to the [Prerequisites](./prerequisites#external-connections) section for detailed network requirements.
