...
![Clip button for image insertion](../images/image235.png)

Insert the image and ask the relevant question:

![Example of inserted image with question](../images/image67.png)

## Multiple Images

You can select up to 10 images for processing:

![Multiple image selection interface](../images/image236.png)
