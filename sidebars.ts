          ...
          items: [
            {
              ...
              items: [
                ...
                'user-guide/concepts/datasource-vs-tool',
                'user-guide/concepts/administrative-tools',
            ...
            },
            {
              ...
              items: [
                ...
                'user-guide/assistants/create-assistant-from-template',
                'user-guide/assistants/edit-assistants',
                'user-guide/assistants/delete-assistants-and-chats',
                'user-guide/assistants/report-bug-feature',
                'user-guide/assistants/view-updates',
                ...
                'user-guide/assistants/supported-file-formats-csv',
                'user-guide/assistants/share-assistant-chat',
                'user-guide/assistants/export-chat-messages',
                'user-guide/assistants/marketplace-overview',
                'user-guide/assistants/clone-assistant-from-marketplace',
                'user-guide/assistants/subassistants-orchestrator',
            ...
            },
            {
              ...
              items: [
                ...
                'user-guide/conversational-advice/jetbrains-plugin',
              ],
            },
            {
              type: 'doc',
